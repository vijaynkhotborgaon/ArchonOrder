...
class ControllerModuleTGKSProFilterProduct extends Controller {
	public function index($setting) {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/tg_kspro_filter_product.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/module/tg_kspro_filter_product.tpl', $data);
		} else {
			return $this->load->view('default/template/module/tg_kspro_filter_product.tpl', $data);
		}
	}
}
?>