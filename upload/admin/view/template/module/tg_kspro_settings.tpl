			...
			<div>
				...
				<div class="bg-tabs">
					...
					<div id="tab_gopro" class="tab-content">
						...
						<ul>
						<li style="font-family: 'Roboto', sans-serif;color:#000000;font-size:13px; font-weight:300;"><b>TG KingStore Pro News / Blog</b> - Powerful Blog system to manage all News / Blog for your store.</li>
